...
The active phase is visible through the Reservoir Spatial Budget debug view, so
budget enforcement can be checked against captured pixels rather than inferred
from state alone.
