...
selected samples to the correct source buffer and constants.
...
the single-batch proof case.  The next proof cuts are SDF object-hit replay,
producer-keyed multi-batch replay manifests, and measured rejection precision.
