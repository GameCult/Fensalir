...
nearest-depth-minus-coverage priority path has been cut.  The remaining fault
is precise: the live row ABI is still too texel-shaped.  It carries field id,
travel, normal, support scalar, guide confidence, proposal weights, and stats,
but it does not yet make the selected native-domain coordinate and support
footprint a first-class invariant.
